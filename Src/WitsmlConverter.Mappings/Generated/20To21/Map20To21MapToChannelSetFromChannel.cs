	...
	public class Map20To21MapToChannelSetFromChannel : Altova.TraceProvider
	{
		...
		class seq1_join : IEnumerable
		{
			...
			class Enumerator : Altova.Mapforce.IMFEnumerator
			{
				...
				private IEnumerator var7_uuid;
				private IEnumerator var8_Channel;
				private IEnumerator var9_existenceKind;
				private IEnumerator var10_Channel;
				private IEnumerator var11_Citation;
				private IEnumerator var12_Channel;
				private IEnumerator var13_Index;
				private IEnumerator var14_Channel;
				...
				public bool MoveNext()
				{
					while (state != 0)
					{
						...
						case 17:
							state = 17;
							if (!var5_schemaVersion.MoveNext()) { state = 18; goto case 18; }
						...
						case 20:
							state = 22;
							if (!var6_Channel.MoveNext()) { state = 21; goto case 21; }
							var7_uuid = (Altova.Functions.Core.FilterAttributes(Altova.Functions.Core.CreateQName("uuid", ""), (Altova.Mapforce.IMFNode)(var6_Channel.Current))).GetEnumerator();
							goto case 22;
						case 21:
							state = 25;
						...
						case 22:
							state = 22;
							if (!var7_uuid.MoveNext()) { state = 23; goto case 23; }
							current = Altova.Functions.Core.CreateAttribute(Altova.Functions.Core.CreateQName("uuid", ""), Altova.Functions.Core.Box(Altova.CoreTypes.NodeToString((Altova.Mapforce.IMFNode)(var7_uuid.Current))));
							pos++;
							return true;
						case 23:
							state = 20;
							Altova.Mapforce.MFEnumerator.Dispose(var7_uuid); var7_uuid = null;
							goto case 20;
						case 25:
							state = 27;
							if (!var8_Channel.MoveNext()) { state = 26; goto case 26; }
							var9_existenceKind = (Altova.Functions.Core.FilterAttributes(Altova.Functions.Core.CreateQName("existenceKind", ""), (Altova.Mapforce.IMFNode)(var8_Channel.Current))).GetEnumerator();
							goto case 27;
						case 26:
							state = 30;
						...
						case 27:
							state = 27;
							if (!var9_existenceKind.MoveNext()) { state = 28; goto case 28; }
							current = Altova.Functions.Core.CreateAttribute(Altova.Functions.Core.CreateQName("existenceKind", ""), Altova.Functions.Core.Box(Altova.CoreTypes.NodeToString((Altova.Mapforce.IMFNode)(var9_existenceKind.Current))));
							pos++;
							return true;
						case 28:
							state = 25;
							Altova.Mapforce.MFEnumerator.Dispose(var9_existenceKind); var9_existenceKind = null;
							goto case 25;
						case 30:
							state = 32;
							if (!var10_Channel.MoveNext()) { state = 31; goto case 31; }
							var11_Citation = (Altova.Functions.Core.FilterElements(Altova.Functions.Core.CreateQName("Citation", "http://www.energistics.org/energyml/data/commonv2"), (Altova.Mapforce.IMFNode)(var10_Channel.Current))).GetEnumerator();
							goto case 32;
						case 31:
							state = 35;
							Altova.Mapforce.MFEnumerator.Dispose(var10_Channel); var10_Channel = null;
							var12_Channel = (closure.var1_Channel).GetEnumerator();
							goto case 35;
						case 32:
							state = 32;
							if (!var11_Citation.MoveNext()) { state = 33; goto case 33; }
							current = Altova.Functions.Core.CreateElement(Altova.Functions.Core.CreateQName("eml:Citation", "http://www.energistics.org/energyml/data/commonv2"), (new seq2_join((Altova.Mapforce.IMFNode)(var11_Citation.Current))));
							pos++;
							return true;
						case 33:
							state = 30;
							Altova.Mapforce.MFEnumerator.Dispose(var11_Citation); var11_Citation = null;
							goto case 30;
						case 35:
							state = 37;
							if (!var12_Channel.MoveNext()) { state = 36; goto case 36; }
							var13_Index = (Altova.Functions.Core.FilterElements(Altova.Functions.Core.CreateQName("Index", "http://www.energistics.org/energyml/data/witsmlv2"), (Altova.Mapforce.IMFNode)(var12_Channel.Current))).GetEnumerator();
							goto case 37;
						case 36:
							state = 40;
							Altova.Mapforce.MFEnumerator.Dispose(var12_Channel); var12_Channel = null;
							var14_Channel = (closure.var1_Channel).GetEnumerator();
							goto case 40;
						case 37:
							state = 37;
							if (!var13_Index.MoveNext()) { state = 38; goto case 38; }
							current = Altova.Functions.Core.CreateElement(Altova.Functions.Core.CreateQName("Index", "http://www.energistics.org/energyml/data/witsmlv2"), (new seq2_join((Altova.Mapforce.IMFNode)(var13_Index.Current))));
							pos++;
							return true;
						case 38:
							state = 35;
						...
						case 40:
							state = 40;
							if (!var14_Channel.MoveNext()) { state = 41; goto case 41; }
							current = Altova.Functions.Core.CreateElement(Altova.Functions.Core.CreateQName("Channel", "http://www.energistics.org/energyml/data/witsmlv2"), (new seq2_join((Altova.Mapforce.IMFNode)(var14_Channel.Current))));
							pos++;
							return true;
						case 41:
							state = 0;
							Altova.Mapforce.MFEnumerator.Dispose(var14_Channel); var14_Channel = null;
							return false;
						}
					}
					return false;
