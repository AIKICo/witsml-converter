////////////////////////////////////////////////////////////////////////
//
// tbf/tbf3_ExtensionNameValue.cs
//
...
namespace tbf
{
	...
	public class tbf3_ExtensionNameValue : Altova.TraceProvider
	{
		...
		class seq1_join : IEnumerable
		{
			...
			class Enumerator : Altova.Mapforce.IMFEnumerator
			{
				...
				private IEnumerator var2_tbf9_StringMeasure;
				...
				public bool MoveNext()
				{
					while (state != 0)
					{
						...
						case 1:
							state = 2;
							var2_tbf9_StringMeasure = (tbf.tbf9_StringMeasure.Eval(closure.var1_current)).GetEnumerator();
							goto case 2;
						case 2:
							state = 2;
							if (!var2_tbf9_StringMeasure.MoveNext()) { state = 3; goto case 3; }
							current = var2_tbf9_StringMeasure.Current;
							pos++;
							return true;
						case 3:
							state = 0;
							Altova.Mapforce.MFEnumerator.Dispose(var2_tbf9_StringMeasure); var2_tbf9_StringMeasure = null;
							return false;
						}
					}
					return false;
